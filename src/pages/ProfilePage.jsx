...
import { Loader2, Edit, X, Save, Edit2, User, Mail, ShoppingCart, Wallet, MapPin } from 'lucide-react';
                ...
                {activeTab === 'profile' && (
                    <div>
                        <div className="flex justify-between items-center mb-6">
                            ...
                            {!isEditMode && (
                                <button onClick={() => setIsEditMode(true)} className="flex items-center gap-2 px-4 py-2 text-sm bg-green-600 text-white rounded-lg hover:bg-blue-700 transition">
                                    <Edit size={14} /> Edit
                                </button>
                            )}
                        </div>
