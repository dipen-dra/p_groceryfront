...
//                     <img src="/hamro.png" alt="Hamro Grocery" className="h-10 w-auto" />
//                     <span className="font-bold text-xl text-gray-800">HamroGrocery</span>
//                 </Link>
...
//                  <button onClick={() => { logout(); navigate("/"); }} className="w-full flex items-center gap-4 px-4 py-3 rounded-lg text-gray-700 hover:bg-red-100">
...
//================================================================================
// FILE: src/pages/UserDashboard.jsx (Corrected)
// DESC: Added the missing import for AuthContext.
//================================================================================
import React, { useState, useContext, useRef, useEffect } from 'react';
import { Routes, Route, Link, Navigate, useLocation, useNavigate } from 'react-router-dom';
import { Home, ShoppingCart, Package, User, LogOut, Menu, X, ChevronDown } from 'lucide-react';
