...
// import React, { useState, useContext, useRef, useEffect } from 'react';
// import { Routes, Route, Link, Navigate, useLocation } from 'react-router-dom';
// import { Home, Package, User, LogOut, Menu, X, ChevronDown, Wallet, ShoppingCart } from 'lucide-react';
// import { AuthContext } from '../auth/AuthContext.jsx';
// import { CartContext } from '../context/CartContext.jsx';
// import { fetchCategories } from '../services/userServices.js';
// import ProductsPage from './ProductsPage.jsx';
// import ProfilePage from './ProfilePage.jsx'; // <-- Use the new centralized profile page
// import CartPage from './CartPage.jsx';
// import CheckoutPage from './CheckoutPage.jsx';
// import { Avatar } from '../components/Avatar';
// import ShoppingList from '../components/ShoopingList.jsx';
...
//     // Determine if the current page is the main shop page to show the category navbar
//     const isShopPage = location.pathname.endsWith('/dashboard/shop') || location.pathname.endsWith('/dashboard/');
...
//             <nav className="flex-1 px-4 py-6 space-y-2">
//                 <NavLink to="/dashboard/shop" icon={Home}>Shop</NavLink>
//                 <NavLink to="/dashboard/profile" icon={User}>My Account</NavLink>
//             </nav>
//             <div className="p-4 border-t">
...
//                 {/* --- Category Navbar (only on shop page) --- */}
//                 {isShopPage && <CategoryNavbar selectedCategory={selectedCategory} onCategoryChange={setSelectedCategory} />}
...
//                 {/* --- Floating Shopping List (only on shop page) --- */}
//                 {isShopPage && <ShoppingList />}
//             </div>
...
import ProductsPage from './ProductsPage.jsx';
import ProfilePage from './ProfilePage.jsx';
import { MyOrdersPage } from './MyOrderPage.jsx'; // Import the pages directly
import { PaymentHistoryPage } from './PaymentHistory.jsx'; // Import the pages directly
import CartPage from './CartPage.jsx';
import CheckoutPage from './CheckoutPage.jsx';
import { Avatar } from '../components/Avatar';
import ShoppingList from '../components/ShoopingList.jsx';
